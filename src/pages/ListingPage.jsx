        ...
        <div className="bg-black p-8 grid gap-4">
          ...
          {place?.photos?.length > 0 &&
            place.photos.map((photo) => (
              <div key={photo}>
                <img src={"https://api1-flax.vercel.app/uploads/" + photo} alt="" />
              </div>
            ))}{" "}
        </div>
      </div>
            ...
            <div className=" grid">
              {place.photos?.[1] && (
                <img
                  onClick={() => setShowAllPhotos(true)}
                  className="cursor-pointer aspect-square object-cover"
                  src={"https://api1-flax.vercel.app/uploads/" + place.photos[1]}
                />
              )}
              ...
              <div className=" overflow-hidden ">
                {place.photos?.[2] && (
                  <img
                    ...
                    src={"https://api1-flax.vercel.app/uploads/" + place.photos[2]}
                  />
                )}
              </div>
            </div>
